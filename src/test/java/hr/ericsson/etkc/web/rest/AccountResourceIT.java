package hr.ericsson.etkc.web.rest;

import hr.ericsson.etkc.HelpdeskApp;
import hr.ericsson.etkc.config.Constants;
import hr.ericsson.etkc.domain.User;
import hr.ericsson.etkc.repository.AuthorityRepository;
import hr.ericsson.etkc.repository.UserRepository;
import hr.ericsson.etkc.security.AuthoritiesConstants;
import hr.ericsson.etkc.service.UserService;
import hr.ericsson.etkc.service.dto.PasswordChangeDTO;
import hr.ericsson.etkc.service.dto.UserDTO;
import hr.ericsson.etkc.web.rest.vm.KeyAndPasswordVM;
import hr.ericsson.etkc.web.rest.vm.ManagedUserVM;
...
import static hr.ericsson.etkc.web.rest.AccountResourceIT.TEST_USER_LOGIN;
