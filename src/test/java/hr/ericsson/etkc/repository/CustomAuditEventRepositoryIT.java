package hr.ericsson.etkc.repository;

import hr.ericsson.etkc.HelpdeskApp;

import hr.ericsson.etkc.config.Constants;
import hr.ericsson.etkc.config.audit.AuditEventConverter;
import hr.ericsson.etkc.domain.PersistentAuditEvent;
...
import static hr.ericsson.etkc.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
